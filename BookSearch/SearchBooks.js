...
class SearchBooks extends Component {
    ...
    fetchData() {
        ...
        if (this.state.bookAuthor !== '') {
            baseURL += encodeURIComponent(this.state.bookAuthor);
        }
        if (this.state.bookTitle !== '') {
            baseURL += (this.state.bookAuthor === '') ? encodeURIComponent( this.state.bookTitle) : encodeURIComponent(this.state.bookTitle);
        }
